...
LRESULT CALLBACK WndTileProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
	{
		...
		MJ::math::Vector2 mousePosition;
		mousePosition.x = mousePos.x;
		mousePosition.y = mousePos.y;

		int idxX = mousePosition.x / MJ::TilemapRenderer::OriginTileSize.x;
		int idxY = mousePosition.y / MJ::TilemapRenderer::OriginTileSize.y;

		MJ::TilemapRenderer::SelectedIndex = Vector2(idxX, idxY);
	}
	break;
	case WM_PAINT:
	{
		...
		MJ::graphics::Texture* texture
			= MJ::Resources::Find<MJ::graphics::Texture>(L"SpringFloor");
